...
const ACTIVITY_TYPES = ['שיחה', 'פגישה', 'מייל', 'וואטסאפ', 'הצעת מחיר', 'עסקה', 'ליד', 'הערה'];

/* סוגים שהנציג בוחר ידנית בטופס התיעוד */
const LOG_TYPES = ['שיחה', 'פגישה', 'מייל', 'וואטסאפ', 'הצעת מחיר', 'הערה'];

/* תוצאת האינטראקציה */
const OUTCOMES = ['הושלם', 'לא ענה', 'ממתין לתשובה', 'נקבעה פגישה', 'נשלח חומר', 'נדחה', 'לא רלוונטי'];

const SOURCES = ['אתר אינטרנט', 'המלצה מלקוח', 'גוגל', 'פייסבוק ואינסטגרם', 'לינקדאין', 'תערוכה', 'שיחה יזומה'];

/* פרטי הכניסה להדגמה.
   שימו לב: זהו מסך כניסה קוסמטי בלבד. באתר סטטי ללא שרת הבדיקה מתבצעת
   בדפדפן והפרטים גלויים בקוד המקור — אין כאן הגנה אמיתית על מידע. */
const DEMO_AUTH = { user: 'demo', pass: 'demo123' };
...
function buildDemoData() {
  ...
  const activities = [
    { id: 'a1',  customerId: 'c1',  type: 'שיחה',      text: 'שיחה עם אורי כהן — אישר את היקף שלב ב׳, ממתין לאישור סמנכ״ל הכספים. ביקש לקבל את החוזה עד סוף השבוע.', by: 'דנה אברמוב',    date: dayOffset(-2),  time: '10:20', duration: 18, outcome: 'ממתין לתשובה', pinned: true },
    { id: 'a2',  customerId: 'c3',  type: 'פגישה',     text: 'פגישת היכרות באשדוד. הוצגה אינטגרציה למערכת השילוח הקיימת. נוכחים: איתי + מנהל התפעול.', by: 'יואב שרעבי',    date: dayOffset(-1),  time: '09:00', duration: 75, outcome: 'נקבעה פגישה' },
    { id: 'a3',  customerId: 'c14', type: 'ליד',       text: 'ליד חדש נכנס מטופס יצירת קשר באינסטגרם.',                            by: 'מערכת',         date: dayOffset(-1),  time: '21:14' },
    { id: 'a4',  customerId: 'c6',  type: 'הצעת מחיר', text: 'נשלחה הצעת מחיר להרחבת רישיונות ל־40 משתמשים. תוקף ההצעה 30 יום.',   by: 'דנה אברמוב',    date: dayOffset(-3),  time: '14:35', outcome: 'נשלח חומר' },
    { id: 'a5',  customerId: 'c11', type: 'ליד',       text: 'פנייה מהאתר — מתעניין במערכת ניהול צי רכב לכ־25 רכבים.',              by: 'מערכת',         date: dayOffset(-2),  time: '08:47' },
    { id: 'a6',  customerId: 'c5',  type: 'שיחה',      text: 'שיחה ראשונית לאחר התערוכה בתל אביב. נקבעה שיחת המשך לשבוע הבא.',     by: 'אלכס פוליאקוב', date: dayOffset(-4),  time: '11:05', duration: 9,  outcome: 'נקבעה פגישה' },
    { id: 'a7',  customerId: 'c9',  type: 'פגישה',     text: 'פגישת רבעון עם רונטק — שביעות רצון גבוהה, נדונה הרחבת התמיכה ל־24 חודשים.', by: 'אלכס פוליאקוב', date: dayOffset(-5), time: '13:30', duration: 60, outcome: 'הושלם', pinned: true },
    { id: 'a8',  customerId: 'c2',  type: 'מייל',      text: 'סטודיו נועה ביקשו התאמות בהצעה — עדכון מחיר לחבילה השנתית.',         by: 'מיכל בן־דוד',   date: dayOffset(-6),  time: '16:12', outcome: 'ממתין לתשובה' },
    { id: 'a9',  customerId: 'c12', type: 'עסקה',      text: 'העסקה ״מערכת CRM לצוות המכירות״ נסגרה בהצלחה — 52,000 ₪.',           by: 'דנה אברמוב',    date: dayOffset(-14), time: '17:40', outcome: 'הושלם' },
    { id: 'a10', customerId: 'c4',  type: 'עסקה',      text: 'העסקה ״מערכת זימון תורים אונליין״ נסגרה בהצלחה — 21,500 ₪.',         by: 'מיכל בן־דוד',   date: dayOffset(-6),  time: '12:05', outcome: 'הושלם' },
    { id: 'a11', customerId: 'c7',  type: 'שיחה',      text: 'עומר שפירא ביקש פירוט על אבטחת מידע ועמידה בתקן. נשלח מסמך בהמשך.',  by: 'יואב שרעבי',    date: dayOffset(-8),  time: '15:20', duration: 22, outcome: 'נשלח חומר' },
    { id: 'a12', customerId: 'c15', type: 'פגישה',     text: 'סיור בסניף החדש בתל אביב לקראת קמפיין ההשקה.',                        by: 'דנה אברמוב',    date: dayOffset(-9),  time: '10:00', duration: 90, outcome: 'הושלם' },
    { id: 'a13', customerId: 'c13', type: 'מייל',      text: 'התקבל מסמך דרישות טכניות לאוטומציה של קו הייצור.',                    by: 'אלכס פוליאקוב', date: dayOffset(-13), time: '09:22', outcome: 'הושלם' },
    { id: 'a14', customerId: 'c8',  type: 'שיחה',      text: 'עדכון לגבי תקציב שנת הלימודים הבאה — חזרה בספטמבר.',                  by: 'מיכל בן־דוד',   date: dayOffset(-19), time: '11:48', duration: 7,  outcome: 'נדחה' },
    { id: 'a15', customerId: 'c10', type: 'הערה',      text: 'הלקוח לא הגיב לשלוש פניות אחרונות. הועבר לרשימת חידוש קשר.',          by: 'מיכל בן־דוד',   date: dayOffset(-97), time: '10:00', outcome: 'לא ענה' },
    { id: 'a16', customerId: 'c16', type: 'הערה',      text: 'סיום התקשרות — הלקוח עבר לפתרון פנימי.',                              by: 'יואב שרעבי',    date: dayOffset(-124),time: '14:00', outcome: 'לא רלוונטי' },
    { id: 'a17', customerId: 'c1',  type: 'וואטסאפ',   text: 'אורי שלח בוואטסאפ את פרטי איש הקשר בהנהלת החשבונות לצורך החוזה.',     by: 'דנה אברמוב',    date: dayOffset(-9),  time: '19:30', outcome: 'הושלם' },
    { id: 'a18', customerId: 'c1',  type: 'הצעת מחיר', text: 'נשלחה הצעת מחיר מעודכנת לשלב ב׳ — 78,000 ₪, כולל 3 חודשי ליווי.',     by: 'דנה אברמוב',    date: dayOffset(-16), time: '11:15', outcome: 'נשלח חומר' },
    { id: 'a19', customerId: 'c1',  type: 'פגישה',     text: 'פגישת אפיון במשרדי הלקוח — מופו 6 תהליכים לאוטומציה.',                by: 'דנה אברמוב',    date: dayOffset(-28), time: '09:30', duration: 120, outcome: 'הושלם' },
    { id: 'a20', customerId: 'c1',  type: 'שיחה',      text: 'שיחת פתיחה — הוצג היקף הפרויקט וסדר הגודל התקציבי.',                  by: 'דנה אברמוב',    date: dayOffset(-45), time: '16:05', duration: 25, outcome: 'הושלם' }
  ];
